...
(function () {
  ...
  window.addEventListener('error', function (e) {
    ...
    try {
      var _rp = { kind: 'exception', msg: String((e && e.message) || ''), stack: String((e && e.error && e.error.stack) || '').slice(0, 1200), where: 'tool.js', href: String(location.href || '') };
  ...
  window.addEventListener('unhandledrejection', function (e) {
    ...
    try {
      var _rr = { kind: 'rejection', msg: String((r && r.message) || r || ''), stack: String((r && r.stack) || '').slice(0, 1200), where: 'tool.js', href: String(location.href || '') };
