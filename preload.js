...
contextBridge.exposeInMainWorld('txapi', {
  ...
  set_project_watermark: (project, wm, enabled, applyToAll) => invoke('set_project_watermark', project, wm, enabled, applyToAll),
